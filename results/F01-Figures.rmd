...
#kableExtra::save_kable(sample_table, file = "./results/paper_figures/sample_table.png", density = 600, zoom = 3)
...
# Print means, median and std dev for each tool in wide
cat("Tool | Mean | Median | Inter Quartile Range\n")
wide %>%
    summarise(tecat = mean(TECAT_mbpsec), telogator = mean(TELOGATOR_mbpsec))
wide %>%
    summarise(tecat = median(TECAT_mbpsec), telogator = median(TELOGATOR_mbpsec))
wide %>%  
    summarise(tecat = IQR(TECAT_mbpsec), telogator = IQR(TELOGATOR_mbpsec))
